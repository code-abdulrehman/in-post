            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-between">
                    <button
                        ...
                        :class="['border-none w-5 h-5 rounded-md p-0 cursor-pointer outline-none outline-offset-1', { 'outline-primary': layoutConfig.primary === primaryColor.name }]"
            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-between">
                    <button
                        ...
                        :class="[
                            'border-none w-5 h-5 rounded-md p-0 cursor-pointer outline-none outline-offset-1',
